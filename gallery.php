    ...
    <div id="content">
    	<div id="gallerycontainer">
			<ul class="portfolio-categ filter">
				...
				<li class="cat-item-1"><a href="#" title="Category 1">Super Deluxe</a></li>
				<li class="cat-item-2"><a href="#" title="Category 2">Deluxe</a></li>
				<li class="cat-item-3"><a href="#" title="Category 3">AirConditioned</a></li>
				<li class="cat-item-4"><a href="#" title="Category 4">Reconditioned</a></li>
			</ul>
			<ul class="portfolio-area" style="width: 860px;">	
                   ...
                   <div class="home-portfolio-text">
                    ...
                    <p class="post-subtitle-portfolio">released: 2019</p>
					</div>
