...
<div id="wrapper">
    	...
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<span style="margin-right: 11px;">No. of Passengers: 
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="#"><strong>Airconditioned Bus</strong><br />
            ...
            <p><a href="lodging.php"><strong>From Kle to Kla Vice versa</strong><br />
			Spend a relaxing trip in our newly acquired fleet. </a></p>  
			</div>
			
        </div>
    </div>

	<div id="footer"><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
